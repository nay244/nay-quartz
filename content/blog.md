...
A space for longer-form writing — thoughts, reflections, and explorations that don't fit neatly into any single node.

---

## What you'll find here

This is where I write when something is worth more than a note but less than a finished project. Posts range from technical deep-dives and tool reviews to personal reflections on learning, travel, and life in general.

Topics that show up often:

- **Cybersecurity & data** — writeups, tool explorations, and lessons from the field
- **Tech culture** — thoughts on the industry, remote work, and building things
- **Learning in public** — what I'm studying, what's clicking, what isn't
- **Slice of life** — shorter, more personal pieces

---

*More posts coming soon. This node is under construction.*
